...
The local review matrix contains seven upscale routes: 360p to 720p/1080p,
480p to 720p/1080p/1440p, 720p to 1080p/1440p, and 1080p to 1440p. It uses
the daylight and cave scenes and four delivery paths: the latest-fix Temporal
Forge baseline, baseline + CAS 0.20, conventional Lanczos, and conventional
cubic. Missing validated assets display `images/no_image.svg`; arbitrary
